...
\begin{figure} [ht!]
    \centering
    \rotatebox{90}{\includegraphics[scale=.85]{bimanual.png}}
...
\begin{figure} [ht!]
    \centering
    \rotatebox{90}{\includegraphics[scale=.85]{ficha de operacion.png}}
...
\section{Capítulo 10: Costos industriales}

Primero, que es un costo? Es una erogación (Desembolso de dinero para cubrir una obligación pendiente) ó desembolso para producir un bien ó la prestación de un servicio.

Podemos decir que los costos industriales, son todos los recursos económicos utilizados en el proceso de producción de bienes o servicios, incluyendo materias primas, mano de obra directa y costos indirectos de fabricación. Representan el valor del esfuerzo productivo.

La  necesidad de conocer los costos industriales se presentan a continuacion:

\begin{itemize}
    \item Competir con inteligencia, sabiendo hasta dónde podemos reducir márgenes sin perder rentabilidad.
    \item Evaluar inversiones, calculando el retorno y priorizando mejoras que reduzcan costos productivos.
    \item Tomar decisiones con fundamentos sólidos, evitando improvisaciones financieras.
\end{itemize}

Podemos 'diferenciar' entre dos costos a priori:

Costo de un producto: es la sumatoria de todos los gastos necesarios para la fabricación y comercialización de una unidad, incluyendo costos de producción, administrativos y de venta asociados directamente. Conocer este costo permite determinar el punto de equilibrio, analizar la rentabilidad y tomar decisiones estratégicas frente a variaciones del mercado.

Costo de produccion: es el valor monetario de los materiales directos, la mano de obra directa y los gastos indirectos de fabricación utilizados para obtener un producto terminado. No incluye costos de comercialización ni financieros. Es clave para calcular el costo unitario, optimizar procesos y definir estrategias de mejora en planta.


\subsection{Sistemas de costos}

El término «sistema de costos» se utiliza porque implica un enfoque sistemático y estructurado para recopilar, clasificar, asignar y analizar los costos. el término «sistema» implica que los costos se registran y se manejan de manera continua y consistente a lo largo del tiempo.

Conjunto organizado de métodos y procedimientos que permiten registrar, clasificar y asignar los costos a los productos o servicios, facilitando el cálculo del costo unitario y el análisis financiero para la toma de decisiones.

\begin{itemize}
    \item Los sistemas de costos permiten estimar con precisión los costos unitarios de un producto.
    \item Son herramientas de gestión, no un fin en sí mismos
    \item La eficacia depende de la capacidad del equipo para interpretar la información y tomar decisiones acertadas.
    \item Un buen sistema es base para mejorar la competitividad y rentabilidad.
\end{itemize}


\subsection{Composición del Costo Total}
Falta señalar en la imagen que mano de obra directa y cargas fabriles, son costos de transformación.

Se detallaran cada uno:

\begin{itemize}
    \item \textbf{Materias primas:} es el material que se consume en cantidad definida por cada unidad de producto y su consumo se mantiene proporcional con el número de unidades. Incluye tanto los materiales efectivamente incorporados como aquellos que, por limitaciones del proceso (tolerancias, rebabas, viruta, recortes), resultan en desperdicios técnicos controlados.
    \item \textbf{Mano de obra (MOD):}esfuerzo físico o intelectual humano aplicado directamente sobre el proceso de transformación del producto, ya sea en operaciones de fabricación, ensamblado, verificación o ajuste. La mano de obra puede ser DIRECTA (Interviene directamente sobre la pieza o producto (ej. operador de torno, soldador, ensamblador)) o INDIRECTA (Da soporte al proceso productivo sin modificar el producto (ej. mantenimiento, calidad, logística interna))
    \item \textbf{Cargas fabriles:}  son todos aquellos recursos económicos aplicados al proceso productivo que no pueden asignarse de manera directa a una unidad de producto, pero que son indispensables para su elaboración. Comprenden gastos relacionados con el soporte, infraestructura, servicios técnicos y gestión de planta, y se distribuyen proporcionalmente sobre los productos mediante criterios de asignación. 
        \begin{table}[ht!]
        \centering
        \begin{tabular}{|l|l|}
        \hline
        \multicolumn{1}{|c|}{\textbf{Categoría}} & \multicolumn{1}{c|}{\textbf{Ejemplos específicos}} \\ \hline
        \textbf{Mantenimiento} & \begin{tabular}[c]{@{}l@{}}Reparación de máquinas, mantenimiento \\ preventivo, lubricantes, repuestos.\end{tabular} \\ \hline
        \textbf{Calidad} & \begin{tabular}[c]{@{}l@{}}Ensayos, inspecciones, equipos de medición, \\ personal de control de calidad.\end{tabular} \\ \hline
        \textbf{Estructura fabril} & \begin{tabular}[c]{@{}l@{}}Amortización de edificios, \\ iluminación, limpieza de planta.\end{tabular} \\ \hline
        \textbf{Servicios generales} & \begin{tabular}[c]{@{}l@{}}Electricidad, gas, agua industrial, \\ aire comprimido.\end{tabular} \\ \hline
        \textbf{Administración de planta} & \begin{tabular}[c]{@{}l@{}}Sueldos de supervisores, planificación,\\ logística interna.\end{tabular} \\ \hline
        \textbf{Herramientas y útiles} & \begin{tabular}[c]{@{}l@{}}Matrices, fresas, mandriles, calibradores,\\ elementos de desgaste frecuente.\end{tabular} \\ \hline
        \textbf{Transporte interno} & \begin{tabular}[c]{@{}l@{}}Carros, montacargas,\\ sistemas de transferencia entre puestos.\end{tabular} \\ \hline
        \textbf{Ingeniería de procesos} & \begin{tabular}[c]{@{}l@{}}Desarrollo de procesos,\\ documentación técnica, métodos y tiempos.\end{tabular} \\ \hline
        \textbf{Seguros} & \begin{tabular}[c]{@{}l@{}}Pólizas sobre maquinaria,\\ instalaciones y riesgos operativos.\end{tabular} \\ \hline
        \end{tabular}
        \end{table}
    \item \textbf{Gastos de comercialización:} son todos los costos asociados a la promoción, distribución y venta del producto, desde que sale de la planta hasta que llega al cliente final. No forman parte del proceso productivo directo, pero son clave para la viabilidad comercial del negocio. Ej: publicida y marketing (redes, ferias, campañas graficas), logistica externa (envios, distribucion, embalages), comisiones de ventas (comisiones para distribuidores, representantes comerciales), Depósito y distribución (gestioon de stock fuiera de planta, alquilr de depósitos), soporte comercial ( atencion al cliente, catálogos, muestras)
    \item \textbf{Gastos financieros:} son los costos derivados de la obtención y uso del capital necesario para operar, incluyendo la financiación de compras, inversiones, o necesidades de capital de trabajo. Ej: intereses (de prestamos bancarios, créditos para maquinarias), Comisiones bancarias (mantenimiento de cuentas, cobranzas), Descuentos financieros (difierncia por pago anticipado, adelanto a proovedores), pérdida por inflacion o devaluacion (revalorizacion de activos o cuentas a cobrar)
\end{itemize}

La amortización (para activos intangibles) o depreciación (para activos tangibles) es un proceso contable que asigna de manera sistemática el costo de adquisición de un bien de uso a lo largo de su vida útil. No implica una salida directa de dinero, por lo que se considera un costo no erogable, pero refleja el desgaste, obsolescencia o pérdida de valor de los activos utilizados en el proceso productivo.

NO sale de la caja pero se imputa para la baja de impuestos a la ganancia. 

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.9]{costo_total.png}
\end{figure}

El COSTO TOTAL es la suma de los COSTOS FIJOS mas los COSTOS VARIABLES.
...
\begin{equation}
    CV = CV_{unitario} \cdot q
\end{equation}

- CVunitario = valor del costo variable unitario. El costo variable unitario se obtiene dividiendo el costo  variable incurrido durante un periodo de tiempo por el número de unidades producidas

- q=cantidad

Entonces, 
\begin{equation}
    CT = CF + CV_{unitario} \cdot q
\end{equation}

\subsection{Costos directos e indirectos}

Los costos directos o variables, varian de forma proporcional a las unidades producidas. Los costos indirectos o gastos fijos, se mantienen constantes para un nivel de actividad.

\begin{itemize}
    \item Costos Directos: son aquellos costos que pueden asignarse de forma exacta y unívoca a un producto, proceso o departamento específico, debido a su relación física y económica directa con el objeto de costo. Estos costos se miden y controlan con precisión. Por ejemplo: materia prima utilizada para fabricar una pieza, mano de obra aplicada en un proceso, componentes especificos agregados al producto final.
    EJEMPLOS:
    \begin{itemize}
        \item El costo de la materia prima que tiene cada producto (Área de Producción)
        \item El costo del tiempo de trabajo utilizado en operaciones concretas de producción (Área de Producción)
        \item El valor de la comisión que se paga al vendedor por la venta que realiza de un producto. (Área de Comercialización)
        \item El costo del transporte de cada producto que se lleva del almacén de la Empresa al sitio del comprador (Área de comercialización)
    \end{itemize}
    \item Costos Indirectos: son costos que no pueden imputarse directamente a un producto o centro de costo debido a que su relación no es inmediata o física. Por ello, se asignan mediante criterios o bases de distribución razonables, buscando reflejar la participación proporcional de cada producto o área. Por ejemplo, energia electrica del taller, gastos generales de planta.
    EJEMPLOS:
        \begin{itemize}
            \item El costo de elementos físicos necesarios para la producción, como: Energía, Agua, refrigerantes, etc.
            \item El costo de la nómina de administración de la producción (Departamento de Ingeniería Industrial, Departamento de diseño, Departamento de Control de Calidad, Departamento de Mantenimiento y similares )
            \item El costo de la nómina de administración de ventas.
            \item El costo de insumos genéricos de costo muy bajo en relación al costo total de materia prima necesaria para fabricar el producto, como botones e hilos en el caso de confecciones, remaches en el caso de metalmecánica, empaques genéricos y similares.
        \end{itemize}
\end{itemize}
...
\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.8]{cdci.png}
\end{figure}

\subsection{Centro de costo}

Un Centro de Costos es una unidad organizativa o contable donde se acumulan y controlan los costos, permitiendo su análisis y asignación para la gestión eficiente de recursos.

\begin{itemize}
    \item Puede ser un área, departamento, máquina, línea de producción o función administrativa.
    \item No siempre coincide exactamente con la estructura del organigrama, aunque suele estar relacionada.
    \item Incluye tanto unidades productivas (donde se genera valor directo, como talleres, plantas o líneas de montaje) como unidades no productivas (servicios generales, mantenimiento, administración).
    \item Su función principal es facilitar la imputación, control y análisis de costos para mejorar la toma de decisiones y la optimización operativa.
\end{itemize}

\textit{Explicado de manera mas vulgar, sería una caja o balde donde tirás todos los gastos que se generan en una parte de la empresa. Sirve para saber cuánta guita se está yendo en cada parte del negocio. Por ejemplo, dentro de una empresa tenes un taller de soldadura, entonces ese será un centro de costo. O el baño, ese puede ser otro centro de costo.}

\subsubsection{Asignación de Costos Indirectos — Paso a paso técnico}


Cuando un costo no se puede imputar directamente al producto (como la electricidad del taller, sueldos de mantenimiento o depreciación de máquinas), hay que seguir un proceso organizado y justo para repartirlo. Por ende la asignacion de costos indirectos a un producto requiere un tratamiento diferente. 

Ese proceso tiene 3 pasos claves:

\begin{enumerate}
    \item \textbf{Acumular:} Se juntan todos los costos indirectos en ''cajas'' llamadas centros de costos. Por ejemplo: El costo del gas va al centro ''Calefacción''. El sueldo del jefe de taller va al centro. El mantenimiento de las máquinas va a ''Mantenimiento''.
    
    \begin{itemize}
        \item \textbf{Centros de costos productivos}: Son los sectores donde se hace el producto, o sea, que transforman materia prima. Horas de MO, Gastos de mantenimiento, Salarios abonados en el centro de costo, Mano de obra indirecta utilizada, Materiales de consumo, Materiales de limpieza, Gastos telefónicos, Gastos de movilidad, Capacitación
        \item \textbf{Centros de costos de servicio}: No producen, pero dan soporte al proceso. Salario de sus empleados, papelería, movilidad, gestión de cuentas de electricidad. gas agua, Telefonía, capacitaciones.
    \end{itemize}

    Tener bien claro quién gasta qué, para después hacer la redistribución justa y técnica de los costos indirectos.

    \item \textbf{Redistribuir:} Los centros no productivos (como mantenimiento, calidad o administración. No fabrican nada directamente, pero dan soporte) pasan sus costos a los centros productivos, que sí fabrican cosas. ¿Por qué? Porque esos sectores existen para dar soporte a la producción. Se usa una base lógica: horas de servicio, superficie ocupada, cantidad de personal, etc. \textit{Es como repartir los gastos generales del edificio entre los departamentos que viven en él.}
    \item \textbf{Prorratear:} Una vez que los centros productivos tienen todos sus costos (propios + los redistribuidos), se reparten esos costos entre los productos fabricados en cada uno. \textit{Cada producto se lleva su parte justa del costo indirecto.}
\end{enumerate}

\subsubsection{Base común de actividades representativas}

Es una unidad de medida concreta y repetible que usamos para repartir los costos indirectos entre los productos de manera justa y racional. Debe cumplir con:

\begin{itemize}
    \item Estar presente en todos los producto.
    \item Ser cuantificable y objetiva.
    \item Relacionarse directamente con el consumo de recursos.
\end{itemize}

Por ejemplo, en la metalmecanica la base comun sugerida seria la mano de obra directa. En una fundicion, el peso del producto. En la industria textil, los metros lineales de tela usados.

Un ejemplo...

Supongamos que en un mes, tu sector de ensamble gasta \$1.000.000 de costos indirectos (limpieza, RRHH, servicios, ingeniería de proceso...).

Como tenemos tres productos:

\begin{table}[ht!]
\centering
\begin{tabular}{|l|l|l|}
\hline
\multicolumn{1}{|c|}{\textbf{Producto}} & \multicolumn{1}{c|}{\textbf{Horas de mano de obra directa}} & \multicolumn{1}{c|}{\textbf{\% del total}} \\ \hline
Ambulancia & 1000 hh & 50\% \\ \hline
Patrullero & 600 hh & 30\% \\ \hline
Comando Móvil & 400 hh & 20\% \\ \hline
\textbf{Total} & 2000 hh & 100\% \\ \hline
\end{tabular}
\end{table}

Repartís el millón según ese \%: Ambulancia absorbe \$500.000. Patrullero absorbe \$300.000. Comando Móvil absorbe \$200.000

Así, cada unidad lleva una parte justa del gasto general. Se obtiene un costo unitario realista, lo que te permite: presupuestar correctamente cada proyecto, cotizar bien sin regalar rentabilidad, detectar desvíos si un producto gasta mucho indirecto, tomar decisiones de mejora continua con datos duros.

Continuando, otro caso: tomamos un centro de costo cualquiera

\begin{equation}
    t_{cc} = \dfrac{G_{Icc}}{B_{cc}}
\end{equation}

donde,

\begin{itemize}
    \item  tcc es la tasa de costos indirectos por unidad de base común de actividad
    \item GIcc es la suma de costos indirectos asignados al centro de costo en el periodo considerado.
    \item Bcc cantidad de unidades de base común producidas en el mismo periodo.
\end{itemize}

La cantidad de unidades de base comun es:

\begin{equation}
    B_{cc} = \sum (q_{n} \cdot b{n})
\end{equation}
donde, 
\begin{itemize}
    \item qn cantidad de unidades del producto n producidas en el periodo
    \item bn cantidad de unidades de base común de actividad contenidas en una unidad de producto n.
\end{itemize}

Remplazando, la expresión que representa el costo indirecto por cada unidad de producto n:

\begin{equation}
    C_{in} = t_{cc} \cdot b_{n}
\end{equation}


\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.6]{formulasCI.png}
\end{figure}
...
\begin{itemize}
    \item costos indirectos en el periodo considerado \$ 24000.- (Gicc)
    \item Horas hombre empleadas en el periodo considerado 600 hh.(Bcc)
    \item \subitem{-} Costo indirecto por hh en el periodo $ 40/hh ($24000/600hh) (tcc)
    \item Producto Z utiliza 0,40 hh (bn)
    \item El costo indirecto del producto Z será \$16 por unidad Z en el periodo considerado. (\$40/hh*0,40hh) (Cin)
\end{itemize}

Se ha optado como base común la MOD y la condición es que  se encuentre presente en todos los artículos y que sean cantidades que se puedan medir con precisión.


El procedimiento realizado anteriormente vale para la presupuestación del costo de una unidad de un producto antes de su fabricación como también para determinar su costo estandar (es el costo que debiera alcanzarse como objetivo, en condiciones de máxima eficiencia).

Los datos indispensables para aplicar el procedimiento: plano técnico del producto, especificaciones técnicas, volumen estimado de producción, horizonte de la demanda esperada.

Esquematicamente, los pasos a seguir son:

\begin{enumerate}
    \item Establecer el proceso de fabricación(hoja de ruta). Si se trata  de un producto ya en fabricación, se hará un relevamiento del actual proceso.
    \item Determinar cantidad de Material Directo (MD) necesario y  el Costo del material Directo (CMD), se consideran también los desperdicios técnicos.
    \begin{equation}
        CMD = \sum (MD_{i} \cdot CMD_{i})
    \end{equation}
    \item Determinar tiempo de MOD que lleva realizar una unidad de producto y su costo en horas hombre (hh)
    \begin{equation}
        Costo MOD/pieza = Tiempo MOD/pieza \cdot Costo(hh)
    \end{equation}
    El costo hh incluye cargas sociales (aportes, art, seguros, asignaciones)

    \item Determinar por prorrateo los GVF(gastos variables de fabricación) que se cargarán al producto del costeo, para el prorrateo adoptamos una unidad representativa de actividad común, en este caso se adopta las hh de MOD considerando las hh consumidas en el período. Para el cálculo  del coeficiente  de prorrateo (Kgvf)(coeficiente de repartición o cuota horaria expresa cuantos \$ se erogan como GVF por cada hh de MOD) de debemos tener el Monto GVF incurridos en el período y hh de MOD trabajadas en el período
    \begin{equation}
        Kgvf= GVFdel período / hh de MOD del periodo 
    \end{equation}

    Luego, para determinar el Costo de gastos variables de fabricación (Cgvf) prorrateados que corresponde aplicar al producto que estamos costeando será igual al coeficiente de prorrateo por tiempo en hh de MOD necesario para elaborar una pieza:

    \begin{equation}
        Costo GVF/pieza= Kgvf * tiempo en hh de MOD/pieza
    \end{equation}

    \item Determinar por prorrateo los GFF(gastos fijos de fabricación) que se cargarán al producto del costeo, se procede ídem a los GVF. Se calcula coeficiente de prorrateo:
    

    Luego, para determinar el Costo de gastos fijos de fabricación (Cgff) prorrateados que corresponde aplicar al producto que estamos costeando será igual al coeficiente de prorrateo por tiempo en hh de MOD necesario para elaborar una pieza:
    
    \item Cálculo del costo total por pieza
\end{enumerate}

faltan items, completar

\subsection{Punto de equilibrio}

El Punto de Equilibrio es el nivel de actividad (producción o ventas) en el cual los ingresos totales igualan a los costos totales. Es decir, no hay ni pérdida ni ganancia.

\begin{equation}
    Beneficio = Ingresos - Costos Totales = 0
\end{equation}

Los supuestos:
\begin{itemize}
    \item Todos los costos y volúmenes son conocidos:
    \item Las relaciones costo-volumen son lineales
    \item Toda la producción puede ser vendida: Todo lo producido se comercializa en el mismo período. Esto permite igualar la producción con las ventas y simplifica el análisis (producción = ventas).
\end{itemize}

Ventajas:
\begin{itemize}
    \item Simplicidad y claridad visual.
    \item Enfoque en la rentabilidad.
    \item Versatilidad en su presentación: grafica como algebraica.
\end{itemize}

\subsubsection{Conceptos relacionados}

\begin{enumerate}
    \item Costos Fijos (CF): Son aquellos costos que permanecen constantes independientemente del nivel de producción o ventas, al menos dentro de un rango relevante. Ejemplos: alquiler de planta, sueldos administrativos, depreciación.
    \item Costos Variables (CV): Son costos que varían directamente con la producción. A mayor producción, mayor costo variable. Ejemplos: materia prima, mano de obra directa por hora, energía consumida en fabricación.
    \item Margen de Contribución (MC): Es la diferencia entre el Precio de Venta Unitario (PVU) y el Costo Variable Unitario (CVU). Representa la contribución de cada unidad vendida para cubrir los costos fijos y posteriormente generar utilidad.
    \begin{equation}
        MC = PVU - CVU
    \end{equation}
    Este margen es fundamental para determinar cuántas unidades se deben vender para cubrir los costos fijos y alcanzar el punto de equilibrio.

    \item Razón del Margen de Contribución (RMC): Indica qué porcentaje de cada peso vendido queda disponible para cubrir los costos fijos y luego generar utilidad. Es una medida de eficiencia económica en la estructura de costos del producto.
    \begin{equation}
        RMC =\dfrac{\text{Márgen de contribución (MC)}}{\text{Precio de venta unitario (PVU)}} \cdot 100
    \end{equation}
\end{enumerate}

\subsubsection{Diagrama de KNOEPEL}

El Diagrama de Knoepfel es una representación gráfica del análisis del punto de equilibrio entre dinero (\$) e unidades producidas (n). Permite visualizar en qué momento una empresa cubre todos sus costos (fijos y variables) y comienza a generar utilidades.

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.7]{knoepel.png}
\end{figure}

donde: 

\begin{itemize}
    \item CF (línea horizontal verde): Costos Fijos. No cambian con la producción.
    \item CV (línea azul punteada): Costos Variables. Aumentan proporcionalmente con la cantidad producida.
    \item CT (línea verde inclinada): Costos Totales. Suma de CF + CV.
    \item IV (línea roja): Ingresos por ventas. Representa el dinero generado por la venta de cada unidad.
    \item U (flecha naranja): Utilidad. Es la distancia vertical entre IV y CT cuando se produce más allá del punto de equilibrio.
    \item Zona de pérdidas: Cuando IV < CT (a la izquierda del punto de equilibrio).
    \item Punto de Equilibrio (IV = CT): Donde los ingresos igualan a los costos totales. A partir de ahí se empieza a generar ganancia.
\end{itemize}
\clearpage
¿Cómo correr el punto de equilibrio hacia la izquierda? Esto implica llegar al equilibrio con menos unidades producidas, es decir: reducir costos o aumentar el margen por unidad. 

\begin{enumerate}
    \item {Reducir Costos Variables:} Se aplican por unidad producida: materiales, mano de obra directa, energía por ciclo, insumos.
    \begin{figure} [ht!]
        \centering
        \includegraphics[scale=.6]{bajandocostos.png}
        \caption{Reducir Costos Variables}
    \end{figure}
    \item {Reducir los Costos Fijos:} Son los costos que no cambian con la producción, como alquileres, seguros, sueldos administrativos, servicios generales.
    \begin{figure} [ht!]
        \centering
        \includegraphics[scale=.6]{bajandocf.png}
        \caption{Reducir los Costos Fijos}
    \end{figure}
    \item {Aumentar el Precio de Venta Unitario:} Si se sube el precio sin que se caigan las ventas, el margen sube.
    \begin{figure} [ht!]
        \centering
        \includegraphics[scale=.6]{subpre.png}
        \caption{Aumentar el Precio de Venta Unitario}
    \end{figure}
\end{enumerate}
...
\begin{enumerate}
    \item  Todas las empresas tienen un punto por debajo del cual pierden dinero. (es importante saber cuál es ese Punto de Equilibrio)
    \item El costo total unitario disminuye al aumentar el número de unidades producidas.
\end{enumerate}

\textbf{Interpretación del punto de equilibrio:}

El Punto de Equilibrio indica el mínimo volumen de producción/ventas necesario para no perder dinero. A partir de ahí, cada unidad vendida genera utilidad. El análisis del Margen de Contribución (MC) y su razón (RMC) permite proyectar escenarios, definir precios, y ajustar estructura de costos.

Cuanto más alta sea la RMC, menor será el volumen de ventas que deba realizar la empresa para cubrir sus costos y empezar a generar utilidades. A su vez, esto indica que los productos que tengan un MC menor deberían tener una rotación más alta, que permita cubrir los costos fijos y alcanzar una utilidad.

A partir de lo anterior, la empresa puede tomar decisiones respecto al precio y los costos de sus productos: 
\begin{itemize}
    \item Puede realizar simulaciones para determinar hasta qué punto es factible disminuir el precio de sus productos sin generar pérdidas, o por el contrario, si debe aumentar el precio de estos para lograr cubrir sus costos fijos.
    \item Al mismo tiempo, puede determinar si es necesario revisar sus costos fijos, en caso de que el margen de contribución no esté alcanzando para cubrirlos.
\end{itemize}

\textbf{Importancia de determinar el punto de equilibrio:}

\begin{enumerate}
    \item Permite medir la rentabilidad mínima esperada: Determina con precisión cuánto debe vender una empresa para no perder dinero. Esto permite fijar objetivos comerciales realistas y entender la viabilidad económica de un proyecto o línea de producción.
    \item \textbf{Optimiza el control de costos:} Al conocer el PE, se puede analizar el comportamiento de los costos totales, diferenciando entre: costos fijos (no cambian con el nivel de producción (alquileres, sueldos administrativos, seguros, etc.)) y costos variables (se incrementan con la producción (materias primas, mano de obra directa, energía, etc.)).
    \item \textbf{Facilita la proyección financiera y de ventas:} permite hacer proyecciones tomando como base datos históricos o actuales. Simular escenarios aumentando o reduciendo precios, cambios de CV (por inflacio, por ejemplo), cambios en la estructura de costos fijos (inversiones, ampliaciones, nuevos contratos, por ejemplo)
    \item \textbf{Mejora la estrategia comercial y de precios:} permite de manera objetiva explicar la situación de las ventas y actualidad de la empresa.
    \item \textbf{Sirve como herramienta de evaluación para nuevos proyectos:} Antes de lanzar un nuevo producto o línea de negocio, calcular su PE permite estimar cuán viable es la inversión y qué nivel de ventas será necesario para justificarla. Este análisis es clave para disminuir riesgos y evitar decisiones impulsivas.
    \item \textbf{Permite priorizar líneas de producto:} permite determinar muy rápidamente la rentabilidad aproximada de cada línea de productos. Comparando el margen de contribución unitario (MC) y la razón del margen de contribución (RMC) entre distintos productos, se pueden: eliminar o revisar productos poco rentables, incentivar la venta de productos con alto aporte a la cobertura de CF, optimizar la estructura de ventas con foco en la rentabilidad real más que en el volumen.
\end{enumerate}

El Punto de Equilibrio no es un dato estático, sino una herramienta viva que se debe recalcular con frecuencia. Su análisis impulsa una gestión más eficiente, estratégica y basada en datos, permitiendo anticipar problemas, maximizar oportunidades y garantizar la sustentabilidad financiera del negocio.

\clearpage
\section{Capítulo 11: Gestión de inventarios}

\textbf{Inventario} es el conjunto de bienes (tangibles) que una empresa posee y que están destinados a ser utilizados en su operación (proceso productivo, venta). Dependiendo del tipo de organización, esto puede incluir:

\begin{itemize}
    \item Materias primas: insumos que aún no han sido transformados.
    \item Productos en proceso: bienes que están siendo manufacturados.
    \item Productos terminados: artículos listos para ser vendidos o distribuidos.
    \item Suministros: materiales auxiliares necesarios para operar (herramientas, repuestos, etc.).
\end{itemize}

El inventario representa una parte del capital de trabajo de la empresa y cumple un rol estratégico: garantizar que siempre haya disponibilidad de lo necesario para producir, vender o brindar servicios.

Tener inventario es como tener una reserva: puede salvarte de interrupciones, pero también genera costos si no se gestiona bien. Por eso entra en juego la gestión de inventarios, que busca administrarlo con inteligencia.

\textbf{Gestión de inventarios} es el conjunto de actividades, procesos y estrategias destinadas a planificar, controlar y supervisar el flujo de materiales, productos y suministros dentro de una organización. Su objetivo principal es asegurar la disponibilidad de los insumos necesarios en el momento y lugar adecuados, minimizando al mismo tiempo los costos asociados al almacenamiento, manejo y obsolescencia.


\subsection{Objetivos de los inventarios}
Existen cuatro razones fundamentales por las que las empresas lleven un inventario:

\begin{enumerate}
    \item \textbf{Protección contra las incertidumbres:} En los sistemas de inventarios, existen incertidumbres en la oferta, en la demanda y en los tiempos de espera. El inventario de seguridad es aquel que se mantiene para protegerse contra esas incertidumbres. De manera similar, se mantienen inventarios de seguridad de materias primas para absorber las incertidumbres en las entregas por parte de los proveedores en términos tanto de cantidad como de la oportunidad de la entrega. Se mantienen inventarios de seguridad de producción en proceso para permitir irregularidades inesperadas, trabajadores poco confiables y modificaciones en el programa. La mayoría de los inventarios de seguridad pueden reducirse mejorando la coordinación con los proveedores y los clientes en la cadena de suministro
    \item \textbf{Permitir una producción y compras económicas:} Una razón clave para mantener inventarios es que producir o comprar en lotes grandes suele ser más económico. Esto permite reducir costos de preparación, aprovechar descuentos por cantidad y optimizar el uso de equipos. Este tipo de inventario se llama "inventario de ciclo". Sin embargo, con métodos como la manufactura esbelta, las empresas buscan reducir los tiempos y costos de preparación, lo que permite trabajar con lotes más pequeños y menos inventario, acercándose al ideal de producir una unidad por vez sin desperdicio.
    \item \textbf{Cubrir los cambios anticipados en la demanda o en la oferta:} por ejemplo: un productor de acondicionadores de aire puede usar una estrategia uniforme de producción aun cuando la mayoría de dichos acondicionadores se vendan durante el verano.
    \item \textbf{Prever el tránsito:} . Los inventarios que se desplazan de un punto a otro en la cadena de suministro se conocen como inventarios en trámite o inventarios en tránsito. Dichos inventarios son afectados por las decisiones de ubicación de la producción y por la elección del transportista y pueden tener un tamaño significativo cuando se emplean barcos en lugar de aviones para transportar los bienes.
\end{enumerate}

\subsection{Problemas que enfrentan las empresas al mantener inventarios altos:}

\begin{itemize}
    \item 
\end{itemize}

\subsection{Componentes de costos}
\begin{itemize}
    \item Costos de Compra o Adquisición: Costo de una compra al proveedor o de una corrida de producción
    \item Costo de Almacenamiento Costo asociado con la posesión o manejo del inventario a través del tiempo. Los costos que podemos encontrar son los siguientes: Seguros, roturas, almacén, costo capital inmovilizado.
    \item Costo de Preparar Pedido Costo de Preparar una máquina o proceso para la fabricación de un pedido. También se pueden considerar los costos administrativos de emisión de pedidos.
    \item Costo de Ruptura o agotamiento Costo que se produce cuando la demanda supera la cantidad de mercadería en inventario.
\end{itemize}

Una administración eficiente del inventario requiere comprender los distintos costos asociados a su existencia, adquisición y manejo. Estos son los principales componentes:

\begin{enumerate}
    \item Costo de adquisición: Representa el gasto total por la compra del producto o insumo.
    \begin{equation}
        \text{Costo de adquisición} = Q \cdot b
    \end{equation}
    Q es la cantidad comprado y b costo unitario del producto.

    \item Costo de pedido (o de lanzamiento de producción): ncluye todos los costos fijos asociados a cada orden de compra o producción, como trámites administrativos, transporte, carga, programación de máquinas, etc.
    \begin{equation}
        \text{Costo de pedido} = K \cdot \dfrac{D}{Q}
    \end{equation}
    K es el costo fijo por pedido, D es la demanda total anual, Q es el tamaño del pedido.
    
    
    \item Costo de almacenamiento (o de mantenimiento): Refleja el costo de conservar productos en stock, incluyendo espacio, seguros, deterioro, obsolescencia, y costo de oportunidad del capital inmovilizado.
    \begin{equation}
        \text{Costo de almacenamiento} = p \cdot b \cdot \dfrac{Q}{2}
    \end{equation}
    

    \item Costo de ruptura o agotamiento: Es el costo asociado a no tener inventario disponible cuando se genera una demanda: perdida de ventas, daño en la relación de clientes, paradas de produccion.
    
\end{enumerate}

\subsection{Cantidad económica de la orden}

\subsubsection{1er caso: Comportamiento Modelo Cantidad Económica de Pedido }
El objetivo específico es seleccionar el Q que minimice los CVT (costo variable total anual del inventario)

Se excluye el costo de la compra del producto, que es fijo y costos por faltantes, quedando:

\begin{equation}
    CVT= \text{costo de ordenar anual} + \text{costo de mantener anual}
\end{equation}

Las consideraciones son:

\begin{itemize}
    \item La demanda es conocida y se produce a una tasa de tiempo constante.
    \item La política de Inventario que se utiliza es la de revisión continua.
    \item No se permiten rupturas de stock.
    \item El volumen del pedido es constante.
    \item Se emite una orden de pedido cuando el inventario llega a cero.
    \item El pedido se recibe instantáneamente (período adelanto = 0).
    \item La mercadería se recibe en un solo lote.
    \item El costo del producto es constante, no importa la cantidad que se pida.
    \item Los costos almacenamiento y pedido se consideran constantes en el horizonte de tiempo.
\end{itemize}

Q es la cantidad a ordenar. El objetivo es calcular el $Q^{*}$ optimo.

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=1]{eoq1.png}
\end{figure}

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=1]{oeq2.png}
\end{figure}
...
\begin{itemize}
    \item Q*: Cantidad óptima de pedido
    \item K: Costo de Pedido 
    \item D: Demanda
    \item H: Costo de Almacenamiento = p*b donde bes la tasa de almacenaje del artículo en el año y p el recio unitario del artículo almacenamiento.
\end{itemize}

A tener en cuenta para los ejercicios:
\begin{itemize}
    \item La cantidad optima de pedidos se obtiene con la fórumla $Q^{*}$. (la de la raiz)
    \item Costo Variable Total de Tenencia de Inventario con CT (ver grafico, es la suma)
    \item Cantidad de pedidos a realizar (np=demanda D / cantidad optima de pedidos)
    \item Tiempo entre pedidos (dias de trabajo / np)
    \item nivel del reorden suponiendo que por mes se trabajan 20 días y que el tiempo de adelanto es de 3 días.  (= demanda diaria D/dias * tiempo de adelanto(dias))
\end{itemize}


%\subsubsection{2do caso}

El EOQ es un modelo de inventario que permite determinar el lote óptimo a pedir, también es necesario llevar un registro de inventario continuo (sistema de revisión continua), para detectar con exactitud cuando llega al punto de reorden.

Según el modelo, el nivel de inventario bajará hasta 0 en el mismo instante en que ocurre la entrega. Pero, ¿si el proveedor no es confiable con el tiempo de entrega?, Entonces, se deberá aumentar el punto de resurtido para tener un colchón para las entregas retrasadas

\begin{equation}
    \text{Inventario de seguridad=Punto de reorden-demanda esperada durante el tiempo de entrega programado.}
\end{equation}


\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.9]{tercero.png}
\end{figure}

\clearpage
\subsubsection{3er caso: Comportamiento Modelo Lote Económico de Producción}

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.9]{3caso.png}
\end{figure}

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.9]{4fig.png}
\end{figure}


\begin{enumerate}
    \item Fase de utilización y fabricación:
    \begin{itemize}
        \item Durante este tiempo, la producción (p) y el consumo (d) se dan simultáneamente.
        \item Por eso la pendiente es menos empinada: el stock sube a un ritmo de p-d 
        \item Termina en el punto más alto del triángulo, que es Q*
    \end{itemize}
    \item Fase de solo utilización:
    \begin{itemize}
        \item Luego de finalizar la producción, solo se consume el stock a la tasa de demanda d.
        \item El inventario cae linealmente hasta llegar al punto de reorden (r).
    \end{itemize}
\end{enumerate}
Q (altura máxima del triángulo): esta es la cantidad óptima a producir por ciclo, es decir, el lote económico de producción Q*.

\clearpage
\subsubsection{4to caso: Modelo Cantidad Económica de Pedido con Descuento por Cantidad }

A medida que la cantidad comprada supera ciertos umbrales el precio unitario va disminuyendo

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.7]{loteecono.png}
\end{figure}

\begin{figure} [ht!]
    \centering
    \includegraphics[scale=.7]{ct_curva.png}
\end{figure}

La fórmula: 

\begin{equation}
    CT(i) = D \cdot p(i) + \frac{DK}{Q^{*}} + \frac{Q^{*} \cdot H(i)}{2}
\end{equation}

donden p(i): Precio unitario producto





\subsection{Control selectivo de los stocks}


\subsubsection{Método ABC}

El método ABC es una técnica de clasificación de inventarios basada en el principio de Pareto (80/20). Su objetivo es identificar y priorizar los artículos más importantes del inventario para aplicar una gestión diferenciada según su valor y consumo. 

\begin{itemize}
    \item A: Pocas unidades → Alto valor económico → Control estricto
    \item B: Intermedios → Seguimiento regular
    \item C: Muchas unidades → Bajo impacto económico → Control simplificado
\end{itemize}

Las ventajas del método son: 

\begin{itemize}
    \item Optimiza el uso de recursos limitados (personal, dinero, tiempo).
    \item Facilita decisiones de compra, almacenamiento y control.
    \item Permite aplicar diferentes estrategias de gestión según la clase.
\end{itemize}

No todos los artículos requieren el mismo esfuerzo de gestión. El método ABC permite enfocar los recursos en lo que realmente importa.
...
\begin{itemize}
    ...
    \item Presentaciones de clases
    \item IA
    \item ADMINISTRACION DE OPERACIONES – Schroeder 
\end{itemize}
